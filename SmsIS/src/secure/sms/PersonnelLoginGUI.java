...
public class PersonnelLoginGUI extends javax.swing.JDialog {
    ...
    private void loginBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBTNActionPerformed
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/smsis", "root", "");
            ...
            if (rs.next()) {
                // ✅ THIS IS WHERE YOU SET THE LOGGED-IN USER
                ...
                // ✅ Open your dashboard or main GUI
                JOptionPane.showMessageDialog(null, "Login successful!");

                new PersonnelGUI().setVisible(true); // or AdminGUI
