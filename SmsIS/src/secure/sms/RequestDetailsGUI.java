...
public class RequestDetailsGUI extends javax.swing.JDialog {
    ...
    public RequestDetailsGUI(java.awt.Frame parent, Request request) {
        super(parent,true);
        if (request == null) {
        JOptionPane.showMessageDialog(this, "Invalid request data. Cannot display details.", "Error", JOptionPane.ERROR_MESSAGE);
        dispose(); // Or prevent initialization
        return;
    }
    ...
    locationLBL.setText(request.getPurpose());
    purposeLBL.setText(request.getLocation());
    priorityLBL.setText(request.getRequested_by());
    requestedByLBL.setText(request.getPriority());
    ...
    responseGUI.setLocationRelativeTo(this); // optional: center on parent
